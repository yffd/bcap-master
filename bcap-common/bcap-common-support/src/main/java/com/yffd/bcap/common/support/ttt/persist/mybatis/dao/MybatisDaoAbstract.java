package com.yffd.bcap.common.support.ttt.persist.mybatis.dao;
...
import com.yffd.bcap.common.support.ttt.persist.mybatis.MybatisConstants;
import com.yffd.bcap.common.support.exception.BcapMybatisException;
...
public abstract class MybatisDaoAbstract<E> {
	...
	protected Integer selectCountByCustom(String sqlId, Object parameter, boolean shortName) {
		if(StringUtils.isBlank(sqlId)) throw BcapMybatisException.DB_SQL_ID_EMPTY();
	...
	protected <T> PageData<T> selectPageByCustom(String sqlId, String countSqlId, Map<String, Object> paramMap,
		...
		if(null!=pageInfo) {
			if(StringUtils.isBlank(countSqlId)) throw BcapMybatisException.DB_SQL_ID_EMPTY("countSqlId 不能为空");
