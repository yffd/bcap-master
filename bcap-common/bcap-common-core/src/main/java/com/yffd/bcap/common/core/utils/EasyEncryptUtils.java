 ...
 * 函数工具类：加密、解密
 */
public class EasyEncryptUtils {
    private static final Logger LOG = LoggerFactory.getLogger(EasyEncryptUtils.class);

    /**
     * 私有构造方法,将该工具类设为单例模式.
     */
    private EasyEncryptUtils() {
    }
    ...
    public static void main(String[] args) {
		String str = "1";
		String sha = EasyEncryptUtils.encodeSHAString(str);
		System.out.println(sha);
		System.out.println(sha.length());
		
		String md5 = EasyEncryptUtils.encodeMD5String(str);
